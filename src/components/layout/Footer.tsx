    ...
    <footer className="l-footer">
      <div className="l-footer__container">
        ...
        <div className="l-footer__bottom">
          ...
          <div className="l-footer__sns" aria-label="Social links">
            <a href="#" target="_blank" rel="noopener noreferrer" aria-label="X">
              <svg aria-hidden="true" viewBox="0 0 1200 1227" fill="currentColor">
            ...
            <a href="#" target="_blank" rel="noopener noreferrer" aria-label="Threads">
              <svg aria-hidden="true" viewBox="0 0 192 192" fill="currentColor">
